...
The public API lives at the module root (`github.com/go-ruby-actioncable/actioncable`). It is
**Ruby-shaped but Go-idiomatic**: names mirror Ruby's `actioncable`, while the surface follows
...
```go
import "github.com/go-ruby-actioncable/actioncable"
```
...
- **[pkg.go.dev/github.com/go-ruby-actioncable/actioncable](https://pkg.go.dev/github.com/go-ruby-actioncable/actioncable)**

The module's [README](https://github.com/go-ruby-actioncable/actioncable#readme) carries worked
