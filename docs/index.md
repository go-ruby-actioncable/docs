# go-ruby-actioncable documentation

**Pure-Go, MRI-4.0.5-faithful Ruby actioncable (no cgo)**

`go-ruby-actioncable/actioncable` is a faithful, pure-Go (zero cgo) reimplementation of Ruby's `actioncable`,
matching reference Ruby (MRI) behaviour. The module path is
`github.com/go-ruby-actioncable/actioncable`.
...
!!! success "Status: pure-Go, CGO=0, differential-tested"
    A faithful pure-Go port of Ruby's `actioncable`, validated against reference Ruby, at 100%
...
| Repo | What it is |
| --- | --- |
| [`actioncable`](https://github.com/go-ruby-actioncable/actioncable) | the library — Ruby's `actioncable` in pure Go |
| [`docs`](https://github.com/go-ruby-actioncable/docs) | this documentation site (MkDocs Material, versioned with mike) |
| [`go-ruby-actioncable.github.io`](https://github.com/go-ruby-actioncable/go-ruby-actioncable.github.io) | the organization landing page (Hugo) |
| [`brand`](https://github.com/go-ruby-actioncable/brand) | logo and brand assets |
...
Source lives at [github.com/go-ruby-actioncable/actioncable](https://github.com/go-ruby-actioncable/actioncable).
